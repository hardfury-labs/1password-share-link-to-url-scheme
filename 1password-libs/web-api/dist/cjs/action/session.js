...
var lodash_es_1 = require("lodash-es"),
    Qwest = __importStar(require("qwest")),
    ...
    Session = function() {
        function e(r, t) {
            ...
            this.clearSessionKey = function() {
                ...
                return __awaiter(s, void 0, void 0, function() {
                    var s, o, a, u, c, h, l, d, f, _, p, y, m;
                    return __generator(this, function(v) {
                        switch (v.label) {
                            case 0:
                                return s = "/" === t[0] ? "https://" + this._host + t : t, o = new URL(s).host, a = "accounts." + util.getServerDomainFromAccountDomain(this._host), u = o === this._host || o === a, c = "", h = lodash_es_1.merge({}, this._options, n), l = h.headers || {}, this._sessionID && u ? this._sessionKey ? [4, this.createMACHeaderValueForRequest(r, s)] : [3, 2] : [3, 3];
                            case 1:
                            ...
                            case 5:
                                y = i, v.label = 6;
                            case 6:
                                return p = y, this.isSignedIn && (this._lastRequest = Date.now()), m = {
                                    httpMethod: r,
                                    url: t,
                                    sessionId: this._sessionID || "[none]",
                                    requestId: c || util.generateRandomID(8),
                                    start: performance.now()
                                }, logRequestStart(m), [2, Qwest.map(r, s, p, h).then(this._handleQwestResponse(m), this._handleQwestError(m))]
                        }
                    })
                })
        ...
        return Object.defineProperty(e.prototype, "auth", {
            ...
            var i = new URL(t);
            return [e, r.toUpperCase(), i.hostname + "/" + lodash_es_1.trimStart(i.pathname, "/") + "?" + lodash_es_1.trimStart(i.search, "?"), MAC_URI_VERSION, s].join("|")
