...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getDataStreamingSummaryInfo = void 0;
var model = __importStar(require("../../../../model")),
    util_1 = require("../../../../util"),
    serviceaccounts_1 = require("../../../serviceaccounts"),
    getDataStreamingSummaryInfo = function(e) {
        var t = e.CTX,
            r = e.sa;
        return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(i) {
                switch (i.label) {
                    case 0:
                        return i.trys.push([0, 2, , 3]), [4, serviceaccounts_1.getServiceAccount(t, r.uuid, {
                            attrs: model.ServiceAccountUser.Attr.Tokens,
                            mustReload: !0
                        })];
                    case 1:
                        return a = i.sent(), e = getActiveTokens(a.tokens), n = e.length, [3, 3];
                    case 2:
                        return o = i.sent(), console.error("Could not get tokens for " + r.uuid, o), [3, 3];
                    case 3:
                        return [2, {
                            title: r.name,
                            icon: r.avatar,
...
exports.getDataStreamingSummaryInfo = getDataStreamingSummaryInfo;
