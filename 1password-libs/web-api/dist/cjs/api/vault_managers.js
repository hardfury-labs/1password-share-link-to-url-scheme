...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getVaultManagers = exports.VaultManagers = void 0;
var t = __importStar(require("io-ts")),
    util_1 = require("../util"),
    partial_user_1 = require("./partial_user");
exports.VaultManagers = t.readonly(t.type({
    managers: t.readonlyArray(partial_user_1.PartialUser)
}));
var getVaultManagers = function(e, t) {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(r) {
            return [2, e.get("/api/v1/vault/" + t + "/managers").then(util_1.unsafeDecodeAs(exports.VaultManagers))]
        })
    })
};
exports.getVaultManagers = getVaultManagers;