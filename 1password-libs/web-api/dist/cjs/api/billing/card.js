...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getCard = exports.updateCard = exports.deleteCard = exports.changeDefaultCard = exports.addCard = exports.Card = void 0;
var t = __importStar(require("io-ts")),
    validator_1 = require("../../util/validator");
exports.Card = t.readonly(t.type({
    ...
    lastFour: validator_1.withDefault(t.string, "")
}), "Card");
var addCard = function(t, e) {
...
var changeDefaultCard = function(t, e) {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(r) {
            switch (r.label) {
                case 0:
...
var getCard = function(t, e) {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(r) {
            return [2, t.get("/api/v1/cards/" + e).then(validator_1.unsafeDecodeAs(exports.Card))]
        })
    })
};
