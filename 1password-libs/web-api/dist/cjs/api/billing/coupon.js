...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.getValidPromotionFromCode = exports.Promotion = exports.Coupon = void 0;
var t = __importStar(require("io-ts")),
    validator_1 = require("../../util/validator");
exports.Coupon = t.readonly(t.type({
...
}), "Coupon"), exports.Promotion = t.readonly(t.type({
    name: t.string,
    description: t.string,
    trialDays: t.number,
    addTrialDays: t.boolean,
    coupon: t.union([exports.Coupon, t.undefined])
}), "Promotion");
var getValidPromotionFromCode = function(t, e, r) {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(n) {
            return [2, t.get("/api/v2/coupon/" + e + "/" + r + "/check").then(validator_1.unsafeDecodeAs(exports.Promotion))]
        })
    })
};
