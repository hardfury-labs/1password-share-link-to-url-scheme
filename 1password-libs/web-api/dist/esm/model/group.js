...
var mapValues = _mapValues,
    ...
    Group = function() {
        function e(e) {
            ...
            this.accessorType = "group", this.decryptRecoverableKeyset = function(e) {
                return makePromise("decryptRecoverableKeyset", function() {
                    return t.recoverableKeyset ? e.uuid !== t.recoverableKeyset.encryptedBy ? Promise.reject(new Error("Cannot decrypt the group's keyset. It is not encrypted by the given keyset.")) : Keyset.decryptWithKeyset(e, t.recoverableKeyset) : Promise.reject(new Error("Missing recoverable keyset."))
                })
                    ...
                    return __awaiter(t, void 0, void 0, function() {
                        ...
                        return __generator(this, function(n) {
                            switch (n.label) {
                                ...
                                case 2:
                                    return s = n.sent(), [2, GroupMembershipWithKeyset(__assign({
                                        keyset: s,
                                        groupUuid: this.uuid,
                                        memberUuid: r.uuid
                                    }, i))]
                ...
                t._vaultACLs = void 0, t._vaultAccessMap = keyBy(e, function(e) {
                    return e.vaultUuid
                })
            ...
            }, this.uuid = e.uuid ? e.uuid : util.generateUUID(), this.name = e.name, this.type = e.type, this.desc = e.desc, this.activeKeysetUuid = e.activeKeysetUuid, this.createdAt = e.createdAt, this.updatedAt = e.updatedAt, this.attrVersion = e.attrVersion || 0, this.avatar = e.avatar || "", this.permissions = e.permissions || BitSet.empty(), this.activities = [], this.archivedKeysets = [], this._memberships = {}, this._vaultAccessMap = {}, this._vaultACLs = void 0, this._attrMask = 0
        }
        return e.prototype.hasAttrMask = function(e) {
            ...
            this.uuid = e.uuid ? e.uuid : util.generateUUID(), this.name = e.name, this.type = e.type, this.desc = e.desc, this.activeKeysetUuid = e.activeKeysetUuid, this.createdAt = e.createdAt, this.updatedAt = e.updatedAt, this.attrVersion = e.attrVersion || 0, this.avatar = e.avatar || "", this.permissions = e.permissions || BitSet.empty()
            ...
            return BitSet.includes(this.permissions, BitSet.combine(e))
            ...
            get: function() {
                return compact(values(this._memberships))
            },
            set: function(t) {
                var r, i;
            ...
            this._memberships = omit(this._memberships, e.uuid)
        }, Object.defineProperty(e.prototype, "vaultAccessList", {
            get: function() {
                return compact(values(this._getLoadedVaultAccessMap()))
            },
            enumerable: !1,
            configurable: !0
        }), e.prototype.getUnsafeVaultAccessList = function() {
            return compact(values(this._vaultAccessMap))
            ...
            this._vaultAccessMap = omit(this._vaultAccessMap, e.uuid)
