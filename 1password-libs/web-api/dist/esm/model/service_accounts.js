...
var ServiceAccountUser = function() {
    function e(e) {
        this.uuid = e.uuid || "", this.email = e.email || "", this.creatorUuid = e.creatorUuid, this.serviceAccountType = e.serviceAccountType, this.attrVersion = e.attrVersion || 0, this.keysetVersion = e.keysetVersion || 0, this.name = e.name || "", this.state = e.state || "", this.type = e.type || "", this.avatar = e.avatar || "", this.language = e.language || "en", this.combinedPermissions = e.combinedPermissions || BitSet.empty(), this.newsletterPrefs = e.newsletterPrefs || 0, this.preferences = e.preferences || BitSet.empty(), this.externalGUID = e.externalGUID, this.createdAt = e.createdAt, this.updatedAt = e.updatedAt, this.lastAuthAt = e.lastAuthAt, this.activities = e.activities, this.billables = e.billables, this._tokenJtiMap = {}, this._attrMask = 0, this._serviceAccountVaultAccess = e.serviceAccountVaultAccess
    }
    return e.prototype.hasAttrMask = function(e) {
        ...
        set: function(e) {
            this._tokenJtiMap = keyBy(e, function(e) {
...
export var ServiceAccountActions = {
    CreateToken: ObjectDataAccessAcl.ServiceAccountTokenCreate,
    RevokeToken: ObjectDataAccessAcl.ServiceAccountTokenRevoke,
    EditToken: ObjectDataAccessAcl.ServiceAccountTokenEdit,
    CreateServiceAccount: ObjectDataAccessAcl.ServiceAccountCreate,
    EditServiceAccount: ObjectDataAccessAcl.ServiceAccountEdit,
    DeleteServiceAccount: ObjectDataAccessAcl.ServiceAccountDelete,
    EditVaultAccess: ObjectDataAccessAcl.ServiceAccountConnectVaultAccessEdit
};
export var validServiceAccountAcl = Object.values(ServiceAccountActions);
export var ServiceAccountTokenState = {
    Active: "A",
    Revoked: "R"
};