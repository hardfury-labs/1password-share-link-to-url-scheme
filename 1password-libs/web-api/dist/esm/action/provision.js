...
var codeLocation = "action/provision",
    makePromise = mp(codeLocation);
export var createProvisionUser = function(e, r, t) {
    return makePromise("createProvisionUser", function() {
        ...
        var a = new model.Vault({
            ...
            u = getRecoveryGroup(e, {
                attrs: model.Group.Attr.PubKey
            }),
            c = a.generateNewKey(),
            l = getEveryoneVault(e, {
                attrs: model.Vault.Attr.All
            }),
            v = getProvisionManagersGroup(e, {
                attrs: model.Group.Attr.PubKey
            }),
            d = createGroupMembership(e, r, s, {
        ...
        return Promise.all([u, c, l, v, d]).then(function(t) {
            ...
            var c = s.activeKeysetUuid ? findDecryptedKeyset(e, s.activeKeysetUuid) : void 0;
            ...
            return parser.parsePerson(e, r, t, findCachedUser(e, r.uuid))
        })
    })
};
export var startUserProvision = function(e, r, t) {
...
export var completeUserProvision = function(e, r) {
    return makePromise("completeUserProvision", function() {
        var t = api.getProvisionedPersonalVault(e.session, r.uuid).then(function(r) {
                ...
                return e.account ? (r.name = personalVaultName(e.account.type), r.type = model.Vault.TypePersonal, r.encryptAttrs()) : Promise.reject(new Error("Missing account."))
            }).then(function(e) {
...
export var resendUserProvision = function(e, r, t) {
        ...
        return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(o) {
                switch (o.label) {
                    ...
                    case 1:
                        return o.sent(), invalidateCache(e), e.nc.emit(util.notification.UsersChanged), [2]
                }
            })
        })
    })
};
export var resendAllUserProvision = function(e) {
        ...
        return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(r) {
                switch (r.label) {
                    ...
                    case 1:
                        return r.sent(), invalidateCache(e), e.nc.emit(util.notification.UsersChanged), [2]
                }
            })
        })
    })
                ...
                return __awaiter(void 0, void 0, void 0, function() {
                    ...
                    return __generator(this, function(t) {
                        switch (t.label) {
                            ...
                            case 1:
                                return r = t.sent(), [2, {
                                    lastResendAt: dateFromGolang(r.lastResendAt),
...
export var getProvisionManagersGroup = function(e, r) {
    return __awaiter(void 0, void 0, void 0, function() {
        var t, n;
        return __generator(this, function(o) {
            ...
            })) ? [2, getGroup(e, n, r)] : [2, void 0]
        })
    })
};
export var replaceProvisionedUserKeyset = function(e, r, t) {
    return __awaiter(void 0, void 0, void 0, function() {
            ...
            return [2, makePromise("replaceProvisionedUserKeyset", function() {
                return __awaiter(void 0, void 0, void 0, function() {
                    ...
                    return __generator(this, function(m) {
                        switch (m.label) {
                            case 0:
                                return n = util.getValidUserUuid(r), [4, getActiveKeysetForGroup(e, t)];
                            case 1:
                                return o = m.sent(), [4, api.getUserProvisionedKeys(e.session, n)];
                            case 2:
                                return (i = m.sent()).keyset.encryptedBy === (null === (p = null === (d = e.user) || void 0 === d ? void 0 : d.activeKeyset) || void 0 === p ? void 0 : p.uuid) ? [2, {
                                    type: "cannot_decrypt"
                                }] : [4, model.Keyset.generateWithSigningKeys()];
                            case 3:
                                return (s = m.sent()).sn = i.keyset.sn + 1, [4, s.encryptWithKey(o.symKey)];
                            case 4:
                                a = m.sent(), m.label = 5;
                            case 5:
                                return m.trys.push([5, 7, , 8]), [4, parser.parseProvisionedKeys(e, i)];
                            case 6:
                                return u = m.sent(), [3, 8];
                            case 7:
                                return m.sent(), [2, {
                            ...
                            case 9:
                                return c = m.sent(), l = c.groupKeysets, v = c.vaultKeys, [4, api.replaceKeysetForProvisionedUser(e.session, n, {
                                    keys: {
                                        groupKeysets: l,
                                        vaultKeys: v
                                    },
