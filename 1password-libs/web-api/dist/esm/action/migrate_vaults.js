...
import {
    createAccountSplittingVaultPreflight,
    createGeneratedPasswordsVault,
    createVaultForAccountSplitting,
    getGeneratedPasswordsVault,
    getPersonalVault,
    getVault
} from "./vault";
import {
...
export var migrateVaults = function(t, e, r, n) {
            ...
            switch (c.label) {
                case 0:
                    if (r.find(function(t) {
                            return t.type !== Vault.TypeUserCreated
                        })) throw new Error("Unsupported vault type included in selected vaults.");
                    return [4, mustGetPersonalVault(t)];
                case 1:
                    return u = [c.sent()], [4, getGeneratedPasswordsVault(t)];
                case 2:
                    return a = __spread.apply(void 0, [u.concat([c.sent()]), r]), r.length > 0 ? [4, createAccountSplittingVaultPreflight(e)] : [3, 4];
                case 3:
                    return i = c.sent(), [3, 5];
                case 4:
                    i = void 0, c.label = 5;
                case 5:
                    return o = i, [4, batchPromiseAll(function(e) {
                        return __awaiter(void 0, void 0, void 0, function() {
                            var r, n;
                            return __generator(this, function(a) {
                                switch (a.label) {
                                    case 0:
                                        return n = {}, [4, getVaultItems(t, e)];
                                    case 1:
                                        return n.vaultItems = a.sent(), e.type !== Vault.TypeUserCreated ? [3, 3] : [4, getVault(t, e, {
                                            attrs: Vault.Attr.Accessors,
                                            mustReload: !0
                                        })];
                                    case 2:
                                        return r = a.sent(), [3, 4];
                ...
                case 6:
                    return s = c.sent(), [4, getAccountWithAttrs(t, ["groups"])];
                case 7:
                    return c.sent(), l = {
                        successfulVaults: [],
                        failedVaults: [],
                        failedItems: {}
                    }, [4, batchPromiseAll(function(r) {
                        return __awaiter(void 0, void 0, void 0, function() {
                            var a, u, i;
                                ...
                                switch (s.label) {
                                    ...
                                    case 1:
                                        return a = s.sent(), u = r.vaultItems.map(function(t) {
                                            return VaultItem.importFromJson(a, t.exportToJson())
                                        }), [2, patchVaultItems(e, u, a).then(function(t) {
                ...
                switch (f.label) {
                    case 0:
                        switch (u = null === (d = null === (c = r.account) || void 0 === c ? void 0 : c.administratorsGroup) || void 0 === d ? void 0 : d.uuid, n.type) {
                            case Vault.TypePersonal:
                                return [3, 1];
                            case Vault.TypeGeneratedPasswords:
                                return [3, 3];
                            case Vault.TypeUserCreated:
                                return [3, 7]
                        }
                        return [3, 10];
                    case 1:
                    ...
                    case 2:
                        return [2, f.sent()];
                    case 3:
                        return [4, getGeneratedPasswordsVault(t)];
                    case 4:
                        return (o = f.sent()) ? [3, 6] : [4, createGeneratedPasswordsVault(t)];
                    case 5:
                        o = f.sent(), f.label = 6;
                    case 6:
                        return [2, o];
                    case 7:
                        ...
                        return i = createVaultForAccountSplitting, s = [t], l = {
                            name: n.name,
                            desc: n.desc,
                            type: Vault.TypeUserCreated
                        }, [4, getAvatar(r, t, n, a)];
                    case 8:
        ...
        return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(o) {
                switch (o.label) {
                    ...
                    case 1:
                        return u = o.sent(), [4, postImage(e, u)];
                    case 2:
                        return [2, o.sent()]
                }
            })
